...
task1_write_random_numbers_to_file.fill_file_random_numbers('random.txt', 10, 0)
...
# task1_write_random_numbers_to_file.test_fill_file_random_numbers_contains_numbers()